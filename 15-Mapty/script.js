...
class App {
    ...
    _moveToPopup(e){
        ...
        const workout = this.#workouts.find(
            work => String(work.id) === workoutEl.dataset.id
        );
    ...
    // workout.click(); 
    // // é necessário desativar pois os objetos vindos do localStorage não herdarão todos os métodos que herdaram antes, 
    }
